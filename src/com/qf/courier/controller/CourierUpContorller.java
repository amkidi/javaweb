...
@WebServlet("/courierup")
public class CourierUpContorller extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            String putter = req.getParameter("putter");
            String getter = req.getParameter("getter");
            String fromd = req.getParameter("fromd");
            String tod = req.getParameter("tod");
            String state = req.getParameter("state");
            String cno = req.getParameter("cno");
            courierService.upCourier(cno,putter,getter,fromd,tod,state);
